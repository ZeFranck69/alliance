...
class Section {
	...
	animate() {
		const section = this.section.querySelector('.our-activities-short');
		const activitiesWrapper = this.section.querySelector('.our-activities-short-wrapper');
...
export default ActivitiesShort;
