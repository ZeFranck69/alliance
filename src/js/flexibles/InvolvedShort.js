...
class Section {
	...
	animate() {
		const section = this.section.querySelector('.involved-short');
		const involvedWrapper = this.section.querySelector('.involved-short-columns__wrapper');
